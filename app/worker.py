"""A worker: claim a run, execute it, record how it ended. (Same pattern as the library project.)"""
import logging
import os
import socket
import time
...
class Worker:
    def __init__(self, store: RunStore, db: LeaveDb, providers: dict,
                 worker_id: str | None = None, lease_seconds: float = 60.0,
                 on_step=None, record_delay: float = 0.0):
